...
In addition, if extra information (\eg~textual layout) has to be shared amongst various LVs, the patch formalism should be adapted accordingly. % to carry this information.
