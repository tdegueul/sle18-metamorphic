...
\Cref{fig:3fsms} depicts the (manual) implementation of the abstract syntax of this FSM language in the three LVs.\footnote{A demonstration of this example is available on the companion webpage:~\url{https://github.com/FIXME}}
